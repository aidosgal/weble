                            ...
                            <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl bg-main2 bg-opacity-80   rounded-lg py-5 px-2 shadow-xl transition-all">
                                ...
                                <div className="mt-5">
                                    <form action="#" method="POST" onSubmit={sendEmail} class="text-xl text-left mx-5 mt-1 w-auto">
                                      ...
                                      <input type="text" name="name" class="block w-full py-2 mt-2 mb-4 text-white bg-transparent border-0 border-b-2 border-b-gray-400 focus:border-b-purple-500 placeholder:text-gray-400 focus:ring-0 focus:ring-transparent focus:outline-none" placeholder="Ваше имя"/>
                                      <label htmlFor="" className="pl-1">Как с вами связаться?</label>
                                      <input type="text" name="phone" class="block w-full py-2 mt-2 mb-4 text-white bg-transparent border-0 border-b-2 border-b-gray-400 focus:border-b-purple-500 placeholder:text-gray-400 focus:ring-0 focus:ring-transparent focus:outline-none" placeholder="Ваш номер телефона"/>
                                      <label htmlFor="" className="pl-1">Есть ли у вас промокод?</label>
                                      <input type="text" name="" class="block w-full py-2 mt-2 mb-4 text-white bg-transparent border-0 border-b-2 border-b-gray-400 focus:border-b-purple-500 placeholder:text-gray-400 focus:ring-0 focus:ring-transparent focus:outline-none" placeholder="Ваш промокод"/>
                                      <button className="py-3 w-full mt-3 bn5" type='submit'>
                                        Оставить заявку
                                      </button>
                                    </form>
                                </div>
            ...
            <section id="about" className="mx-auto font-kot flex my-auto h-screen">
              <div>
                ...
                <div ref={ref} className="grid grid-cols-3 text-center px-20 gap-6" style={{
                  ...
                  <div className="bg-white bg-opacity-10 rounded-lg text-center py-5 px-2">
                    <div className="mx-auto">
                      <img className="mx-auto" src="1.png" alt="" />
                    </div>
                    <p className="text-xl font-kot text-purple-400">Опыт и компетентность</p>
                  ...
                  <div className="bg-white bg-opacity-10 rounded-lg text-center py-5 px-2">
                    <div className="mx-auto">
                      <img className="mx-auto" src="2.png" alt="" />
                    </div>
                    <p className="text-xl font-kot text-purple-400">Индивидуальный подход</p>
                  ...
                  <div className="bg-white bg-opacity-10 rounded-lg text-center py-5 px-2">
                    <div className="mx-auto">
                      <img className="mx-auto" src="3.png" alt="" />
                    </div>
                    <p className="text-xl font-kot text-purple-400">Качество и профессионализм</p>
                ...
                <div ref={ref2} className="grid grid-cols-3 text-center px-20 gap-6 pt-6" style={{
                  ...
                  <div className="bg-white bg-opacity-10 rounded-lg text-center py-5 px-2">
                    <div className="mx-auto">
                      <img className="mx-auto" src="4.png" alt="" />
                    </div>
                    <p className="text-xl font-kot text-purple-400">Техническая экспертиза</p>
                  ...
                  <div className="bg-white bg-opacity-10 rounded-lg text-center py-5 px-2">
                    <div className="mx-auto">
                      <img className="mx-auto" src="5.png" alt="" />
                    </div>
                    <p className="text-xl font-kot text-purple-400">Удовлетворенные клиенты</p>
                  ...
                  <div className="bg-white bg-opacity-10 rounded-lg text-center py-5 px-2">
                    <div className="mx-auto">
                      <img className="mx-auto" src="6.png" alt="" />
                    </div>
                    <p className="text-xl font-kot text-purple-400">Поддержка и обслуживание</p>
                ...
                <div className="pt-28" style={{
                  ...
                  <Splide options={{
                    ...
                    <SplideSlide>
                      <div className="flex">
                        <div className="">
                          <div className="font-extrabold text-5xl numbers text-center justify-center py-2">1</div>
                        </div>
                    ...
                    <SplideSlide>
                      <div className="flex">
                        <div className="">
                          <div className="font-extrabold text-5xl numbers text-center justify-center py-2">2</div>
                        </div>
                        <div className="py-5 ml-6">
                    ...
                    <SplideSlide>
                      <div className="flex">
                        <div className="">
                          <div className="font-extrabold text-5xl numbers text-center justify-center py-2">3</div>
                        </div>
                        <div className="py-5 ml-6">
                    ...
                    <SplideSlide>
                      <div className="flex">
                        <div className="">
                          <div className="font-extrabold text-5xl numbers text-center justify-center py-2">4</div>
                        </div>
                        <div className="py-5 ml-6">
                    ...
                    <SplideSlide>
                      <div className="flex">
                        <div className="">
                          <div className="font-extrabold text-5xl numbers text-center justify-center py-2">5</div>
                        </div>
                        <div className="py-5 ml-6">
                    ...
                    <SplideSlide>
                      <div className="flex">
                        <div className="">
                          <div className="font-extrabold text-5xl numbers text-center justify-center py-2">6</div>
                        </div>
                        <div className="py-5 ml-6">
                    ...
                    <SplideSlide>
                      <div className="flex">
                        <div className="">
                          <div className="font-extrabold text-5xl numbers text-center justify-center py-2">7</div>
                        </div>
                        <div className="py-5 ml-6">
              ...
              <div className="grid grid-cols-1 mx-auto my-auto px-2 items-center">
                ...
                <div>
                  <div className="pt-6" style={{
                    ...
                    <div className="flex">
                      <div className="pt-2">
                      <div className="font-extrabold text-5xl numbers text-center justify-center py-2">1</div></div>
                      <ul className="pl-4">
                        <li>&#8226; Встреча с клиентом для понимания его потребностей и целей.</li>
                        <li>&#8226; Сбор информации о целевой аудитории и конкурентах.</li>
                      </ul>
                  ...
                  <div className="pt-6" style={{
                    ...
                    <div className="flex">
                      <div className="pt-2">
                      <div className="font-extrabold text-5xl numbers text-center justify-center py-2">2</div></div>
                      <ul className="pl-4">
                        <li>&#8226; Разработка технического задания.</li>
                        <li>&#8226; Определение структуры сайта и создание карты сайта.</li>
                        <li>&#8226; Определение бюджета и сроков выполнения проекта.</li>
                  ...
                  <div className="pt-6" style={{
                    ...
                    <div className="flex">
                      <div className="pt-2">
                      <div className="font-extrabold text-5xl numbers text-center justify-center py-2">3</div></div>
                      <ul className="pl-4">
                        <li>&#8226; Создание дизайн-концепции, включая цветовую палитру и стиль.</li>
                        <li>&#8226; Разработка макетов (wireframes) и мокапов.</li>
                        <li>&#8226; Дизайн пользовательского интерфейса (UI) и элементов.</li>
                  ...
                  <div className="pt-6" style={{
                    ...
                    <div className="flex">
                      <div className="pt-2">
                      <div className="font-extrabold text-5xl numbers text-center justify-center py-2">4</div></div>
                      <ul className="pl-4">
                        <li>&#8226; Выбор технологий и платформы для создания сайта.</li>
                        <li>&#8226; Создание бэкенда (серверной части) и фронтенда (клиентской части).</li>
                        <li>&#8226; Интеграция функциональности, например, форм обратной связи, онлайн-чата и других модулей.</li>
                  ...
                  <div className="pt-6" style={{
                    ...
                    <div className="flex">
                      <div className="pt-2">
                      <div className="font-extrabold text-5xl numbers text-center justify-center py-2">5</div></div>
                      <ul className="pl-4">
                        <li>&#8226; Проведение функционального тестирования, проверка работы всех элементов сайта.</li>
                        <li>&#8226; Отладка и исправление ошибок.</li>
                        <li>&#8226; Тестирование совместимости с разными браузерами и устройствами.</li>
                  ...
                  <div className="pt-6" style={{
                    ...
                    <div className="flex">
                      <div className="pt-2">
                      <div className="font-extrabold text-5xl numbers text-center justify-center py-2">6</div></div>
                      <ul className="pl-4">
                        <li>&#8226; Размещение сайта на хостинге или сервере.</li>
                        <li>&#8226; Настройка DNS и доменного имени, если необходимо.</li>
                        <li>&#8226; Проверка работоспособности на живом сервере.</li>
                  ...
                  <div className="pt-6" style={{
                    ...
                    <div className="flex">
                      <div className="pt-2">
                      <div className="font-extrabold text-5xl numbers text-center justify-center py-2">7</div></div>
                      <ul className="pl-4">
                        <li>&#8226; Обучение клиента управлению сайтом (если используется CMS).</li>
                        <li>&#8226; Подготовка технической документации и инструкций по эксплуатации.</li>
                      </ul>
